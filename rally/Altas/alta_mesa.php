<!-- Sistema de Administracion de Rally de Conocimientos de Fisica, Quimica y Matematicas
    Formulario de Alta de Estaciones o Mesas
...
<html>
	...
	?>
		<h1 style="text-align: center;">Asignar mesa a profesor</h1>
		<p>Si no se muestra nada, debe dar de alta primero a un profesor</p>
		<form method="post" action="./modulos/addmesa.php" name="mesa">
