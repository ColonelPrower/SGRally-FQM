<!-- Sistema de Administracion de Rally de Conocimientos de Fisica, Quimica y Matematicas
   Script de modificacion de mesas
...
<html>
	...
	<?php require_once("../../lib/config.php");
		...
		mysqli_query($conn,"update mesas set maestro='$maestro' where num_mesa='$mesa'") or die ("no se pudo modificar la mesa ".mysqli_error($conn));
		echo("mesa modificada");
	?>
