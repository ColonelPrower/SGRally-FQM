...
<table style="text-align: left; width: 100%; font-family: Helvetica,Arial,sans-serif;" border="1" cellpadding="1" cellspacing="1">
  ...
  <tbody>
    <tr>
      ...
      <td style="font-weight: bold;">Opcion A</td>
      <td style="font-weight: bold;">Opcion B</td>
      <td style="font-weight: bold;">Opcion C</td>
...
<?php while($fila=mysqli_fetch_array($consulta)){
	...
	echo("<br><a href='../../images/reactivos/".$fila['fotoa']."' target=_blank><img  src='../../images/reactivos/".$fila['fotoa']."'></a>"."</td>");
	}
	else{
	...
	echo("<br><a href='../../images/reactivos/".$fila['fotob']."' target=_blank><img  src='../../images/reactivos/".$fila['fotob']."'></a>"."</td>");
	}
	else{
	...
	echo("<br><a href='../../images/reactivos/".$fila['fotoc']."' target=_blank><img  src='../../images/reactivos/".$fila['fotoc']."'></a>"."</td>");
	}
	else{
