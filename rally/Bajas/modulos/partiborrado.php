<!-- Sistema de Administracion de Rally de Conocimientos de Fisica, Quimica y Matematicas
    Script para la eliminacion en la base de datos del equipo seleccionado
...
$participante=$_POST['cod'];
mysqli_query($conn,"Delete from participantes where codigo='$participante'")or die("no se pudo borrar los participantes ".mysqli_error($conn));
mysqli_close($conn);
?>

<h1 align="center">Participante eliminado</h1>
<p align="center"><a href="../borrarparticipante.htm">
Eliminar otro participante</a> </p>
