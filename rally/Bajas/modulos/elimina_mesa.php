<!-- Sistema de Administracion de Rally de Conocimientos de Fisica, Quimica y Matematicas
    Script de eliminacion de una mesa.
...
<title>Mesa eliminada</title>
</head>
<body>
<?php
require_once('../../lib/config.php');
$mesa=$_POST['mesa'];
mysqli_query($conn,"Delete from mesas where num_mesa=$mesa") or die("no se pudo borrar la mesa ".mysqli_error($conn));
mysqli_close();
echo("<h1 align='center'>Mesa eliminada</h1>");
?>
