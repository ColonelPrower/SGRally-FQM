<!-- Sistema de Administracion de Rally de Conocimientos de Fisica, Quimica y Matematicas
    Script de consulta de todos los participantes.
...
$consulta=mysqli_query($conn,"Select * from participantes order by nombre asc");
?>
	<h1 style="text-align: center;">Participantes Registrados</h1>
...
while($fila=mysqli_fetch_array($consulta)){
	...
	if(file_exists("../images/participantes/".$fila['foto'])){
	echo("<td><img style='width: 120px; height: 120px;' src='../images/participantes/".$fila['foto']."'>"."</td>");
	}
	else{
		echo("<td><img style='width: 120px; height: 120px;' src='../images/participantes/default.jpg'>"."</td>");
	}
	echo("</tr>");
}
?>
