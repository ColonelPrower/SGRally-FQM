<!-- Sistema de Administracion de Rally de Conocimientos de Fisica, Quimica y Matematicas
    Script de consulta de un equipo con los miembros que lo conforman y su representante
...
<body>
<h1 align="center">Detalles del equipo</h1>
<br>
<?php require_once('../../lib/config.php');
$numequipo=$_POST['equipo'];
...
$lider=(string)$campo['representante'];
//echo("el lider es: ".$lider);
...
echo("</td>");
//."<td><img alt='sin foto o foto dañada' style='width: 120px; height: 120px;' src='../../images/equipos/".$campo['foto']."'></td>"
echo("</tr>");
?>
</tbody>
</table>
